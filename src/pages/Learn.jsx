const guides = [
  { id: 1, title: "What is Bitcoin?", category: "Crypto Basics", image: "https://images.unsplash.com/photo-1518546305927-5a555bb7020d?auto=format&fit=crop&w=400&q=80" },
  ...
  return (
    <div className="max-w-7xl mx-auto px-8 py-12">
      <div className="text-center mb-16">
        <h1 className="text-5xl font-bold mb-4">Crypto questions, answered</h1>
